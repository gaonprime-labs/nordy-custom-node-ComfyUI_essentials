...
NODE_CLASS_MAPPINGS = {
    "GetImageSize+_legacy-0283ce4": GetImageSize,

    "ImageResize+_legacy-0283ce4": ImageResize,
    "ImageCrop+_legacy-0283ce4": ImageCrop,
    "ImageFlip+_legacy-0283ce4": ImageFlip,

    "ImageDesaturate+_legacy-0283ce4": ImageDesaturate,
    "ImagePosterize+_legacy-0283ce4": ImagePosterize,
    "ImageCASharpening+_legacy-0283ce4": ImageCAS,
    "ImageSeamCarving+_legacy-0283ce4": ImageSeamCarving,
    "ImageEnhanceDifference+_legacy-0283ce4": ImageEnhanceDifference,
    "ImageExpandBatch+_legacy-0283ce4": ImageExpandBatch,
    "ImageFromBatch+_legacy-0283ce4": ImageFromBatch,
    "ImageCompositeFromMaskBatch+_legacy-0283ce4": ImageCompositeFromMaskBatch,
    "ExtractKeyframes+_legacy-0283ce4": ExtractKeyframes,
    "ImageApplyLUT+_legacy-0283ce4": ImageApplyLUT,

    "MaskBlur+_legacy-0283ce4": MaskBlur,
    "MaskFlip+_legacy-0283ce4": MaskFlip,
    "MaskPreview+_legacy-0283ce4": MaskPreview,
    "MaskBatch+_legacy-0283ce4": MaskBatch,
    "MaskExpandBatch+_legacy-0283ce4": MaskExpandBatch,
    "TransitionMask+_legacy-0283ce4": TransitionMask,
    "MaskFromColor+_legacy-0283ce4": MaskFromColor,
    "MaskFromBatch+_legacy-0283ce4": MaskFromBatch,

    "SimpleMath+_legacy-0283ce4": SimpleMath,
    "ConsoleDebug+_legacy-0283ce4": ConsoleDebug,
    "DebugTensorShape+_legacy-0283ce4": DebugTensorShape,

    "ModelCompile+_legacy-0283ce4": ModelCompile,
    "BatchCount+_legacy-0283ce4": BatchCount,

    "KSamplerVariationsStochastic+_legacy-0283ce4": KSamplerVariationsStochastic,
    "KSamplerVariationsWithNoise+_legacy-0283ce4": KSamplerVariationsWithNoise,
    "CLIPTextEncodeSDXL+_legacy-0283ce4": CLIPTextEncodeSDXLSimplified,
    "SDXLEmptyLatentSizePicker+_legacy-0283ce4": SDXLEmptyLatentSizePicker,

    "DrawText+_legacy-0283ce4": DrawText,
    "RemBGSession+_legacy-0283ce4": RemBGSession,
    "ImageRemoveBackground+_legacy-0283ce4": ImageRemoveBackground,

    "RemoveLatentMask+_legacy-0283ce4": RemoveLatentMask,

    #"NoiseFromImage~": NoiseFromImage,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "GetImageSize+_legacy-0283ce4": "🔧 Get Image Size_legacy-0283ce4",
    "ImageResize+_legacy-0283ce4": "🔧 Image Resize_legacy-0283ce4",
    "ImageCrop+_legacy-0283ce4": "🔧 Image Crop_legacy-0283ce4",
    "ImageFlip+_legacy-0283ce4": "🔧 Image Flip_legacy-0283ce4",

    "ImageDesaturate+_legacy-0283ce4": "🔧 Image Desaturate_legacy-0283ce4",
    "ImagePosterize+_legacy-0283ce4": "🔧 Image Posterize_legacy-0283ce4",
    "ImageCASharpening+_legacy-0283ce4": "🔧 Image Contrast Adaptive Sharpening_legacy-0283ce4",
    "ImageSeamCarving+_legacy-0283ce4": "🔧 Image Seam Carving_legacy-0283ce4",
    "ImageEnhanceDifference+_legacy-0283ce4": "🔧 Image Enhance Difference_legacy-0283ce4",
    "ImageExpandBatch+_legacy-0283ce4": "🔧 Image Expand Batch_legacy-0283ce4",
    "ImageFromBatch+_legacy-0283ce4": "🔧 Image From Batch_legacy-0283ce4",
    "ImageCompositeFromMaskBatch+_legacy-0283ce4": "🔧 Image Composite From Mask Batch_legacy-0283ce4",
    "ExtractKeyframes+_legacy-0283ce4": "🔧 Extract Keyframes (experimental)_legacy-0283ce4",
    "ImageApplyLUT+_legacy-0283ce4": "🔧 Image Apply LUT_legacy-0283ce4",

    "MaskBlur+_legacy-0283ce4": "🔧 Mask Blur_legacy-0283ce4",
    "MaskFlip+_legacy-0283ce4": "🔧 Mask Flip_legacy-0283ce4",
    "MaskPreview+_legacy-0283ce4": "🔧 Mask Preview_legacy-0283ce4",
    "MaskBatch+_legacy-0283ce4": "🔧 Mask Batch_legacy-0283ce4",
    "MaskExpandBatch+_legacy-0283ce4": "🔧 Mask Expand Batch_legacy-0283ce4",
    "TransitionMask+_legacy-0283ce4": "🔧 Transition Mask_legacy-0283ce4",
    "MaskFromColor+_legacy-0283ce4": "🔧 Mask From Color_legacy-0283ce4",
    "MaskFromBatch+_legacy-0283ce4": "🔧 Mask From Batch_legacy-0283ce4",

    "SimpleMath+_legacy-0283ce4": "🔧 Simple Math_legacy-0283ce4",
    "ConsoleDebug+_legacy-0283ce4": "🔧 Console Debug_legacy-0283ce4",
    "DebugTensorShape+_legacy-0283ce4": "🔧 Tensor Shape Debug_legacy-0283ce4",

    "ModelCompile+_legacy-0283ce4": "🔧 Compile Model_legacy-0283ce4",
    "BatchCount+_legacy-0283ce4": "🔧 Batch Count_legacy-0283ce4",

    "KSamplerVariationsStochastic+_legacy-0283ce4": "🔧 KSampler Stochastic Variations_legacy-0283ce4",
    "KSamplerVariationsWithNoise+_legacy-0283ce4": "🔧 KSampler Variations with Noise Injection_legacy-0283ce4",
    "CLIPTextEncodeSDXL+_legacy-0283ce4": "🔧 SDXLCLIPTextEncode_legacy-0283ce4",
    "SDXLEmptyLatentSizePicker+_legacy-0283ce4": "🔧 SDXL Empty Latent Size Picker_legacy-0283ce4",

    "DrawText+_legacy-0283ce4": "🔧 Draw Text_legacy-0283ce4",
    "RemBGSession+_legacy-0283ce4": "🔧 RemBG Session_legacy-0283ce4",
    "ImageRemoveBackground+_legacy-0283ce4": "🔧 Image Remove Background_legacy-0283ce4",

    "RemoveLatentMask+_legacy-0283ce4": "🔧 Remove Latent Mask_legacy-0283ce4",
